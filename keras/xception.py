...
if __name__ == "__main__":
    ...
    xception.nn_init(c_lib_p = solib, nb_p = nbfile, level=0)
    print('Done.')
    ...
    start = time.time()
    outputs = xception.nn_inference(cv_img, platform = 'KERAS', reorder='0 1 2', out_format=out_format.OUT_FORMAT_FLOAT32)
    end = time.time()
