...
if __name__ == '__main__':
    ...
    handtiny = KSNN('VIM3')
    print(' |---+ KSNN Version: {} +---| '.format(handtiny.get_nn_version()))
    ...
    while(1):
        ...
        '''
        data = handtiny.nn_inference(cv_img, platform='DARKNET', reorder='2 1 0', output_tensor=3, output_format=output_format.OUT_FORMAT_FLOAT32)
        end = time.time()
        ...
        boxes, scores = handtiny_post_process(input_data)
