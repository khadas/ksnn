...
def yoloface_post_process(input_data):
...
def gen_frames():
    ...
    while(1):
        ...
        boxes, scores = yoloface_post_process(input_data)
...
if __name__ == '__main__':
    ...
    yoloface.nn_init(library=library, model=model, level=level)
    print('Done.')
